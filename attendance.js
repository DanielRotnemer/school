...
function addEvents()
{
    ...
    if ($("[meetingId]").length)
    {
        ...
        {
            var circleId = $(this).attr("participantsCircleId");
            var meetingId = $(this).attr("meetingId");
            var circleMeetingParticipantsScreen = getCircleMeetingParticipantsScreen();
            $("body").append(circleMeetingParticipantsScreen);
            ...
            ({
                ...
                data        : 
                {
                    listType: 'specificCircleMeetingParticipants',
                    participantsCircleId: circleId,
                    participantsMeetingId: meetingId
                },                             
    ...
    if ($("[commentsCircleId]").length)
    {
        $("[commentsCircleId]").off("click");
        $("[commentsCircleId]").on("click", function()
        {
            var circleId = $(this).attr("commentsCircleId");
            var circleCommentsScreen = getCircleCommentsScreen();
            $("body").append(circleCommentsScreen);
            $("body").css("overflow", "hidden");
            resize();
            animationFinished = false;
            $(".secondary-screen-w").animate({opacity: 1}, 400, function() 
...
function getCircleMeetingParticipantsScreen()
{
    var circleMeetingParticipantsScreen = 
    `<div class="secondary-screen-w noselect">
        <div class="secondary-screen" style="width: 460px;">
            <div class="secondary-sc-title-w">
                <div class="secondary-sc-title">משתתפי מפגש החוג</div>
    ...
    return circleMeetingParticipantsScreen;
}

function getCircleCommentsScreen()
{
    var circleCommentsScreen = 
    `<div class="secondary-screen-w noselect">
        <div class="secondary-screen" style="width: 460px;">
            <div class="secondary-sc-title-w">
                <div class="secondary-sc-title">רשימת משובים עבור חוג</div>
                <img class="close-secondary-sc" src="http://` + domain + `/images/close.png"/>
            </div>
            <div class="ssc-body-w">
                <div class="loading">...טוען נתונים</div>
