<?php
    ...
    $document = PAGES::EventManagementPage();
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="http://<?php echo $GLOBALS['SERVER_ADDRESS']; ?>/event.css?crm=<?php echo time(); ?>"/>
        <script src="https://code.jquery.com/jquery-3.3.1.js"></script>
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
        <script src="http://<?php echo $GLOBALS['SERVER_ADDRESS']; ?>/event.js?crm=<?php echo time(); ?>"></script>
